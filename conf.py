...
BLOG_EMAIL = "nicolas.fauchereau@gmail.com"
BLOG_DESCRIPTION = "(Python) code and musings about open source for climate science"  # (translatable)
...
# (translatable)
CONTENT_FOOTER = """<hr>Contents &copy; {date} <a href="mailto:{email}">{author}</a> {license}
<br>Powered by <a href="https://getnikola.com" rel="nofollow">Nikola</a>, zen-ipython theme from <a href="http://www.damian.oquanta.info">Damian Avila</a>"""
